...
public class ViewChiTietSP extends javax.swing.JFrame {
    ...
    public ViewChiTietSP() {
        ...
        loadTT(chiTietSPService.getAll());
    ...
    private void loadTT(List<ViewChiTietSPResponse> listTT) {
        dcbm = (DefaultComboBoxModel) cbbTrangThai.getModel();
        cbbTrangThai.setModel(new DefaultComboBoxModel(new String[]{"Còn Kinh Doanh", "Không còn hoạt động"}));
        for (ViewChiTietSPResponse viewChiTietSPResponse : listTT) {
            dcbm.addElement(viewChiTietSPResponse.hTTrangThai());
        }
    }
    ...
    private void loadTable(List<ViewChiTietSPResponse> list) {
        ...
        for (ViewChiTietSPResponse response : list) {
            dtm.addRow(new Object[]{
                response.getMaSP(), response.getTenSP(), response.getTenAnh(), response.getMauSac(),
    ...
    private void loadTextField(int i) {
        if (tblChiTietSP.getRowCount() > 0) {
            ...
            cbbMaSP.setSelectedItem(tblChiTietSP.getValueAt(i, 0).toString());
            txtTenSp.setText(tblChiTietSP.getValueAt(i, 1).toString());
            cbbMauSac.setSelectedItem(tblChiTietSP.getValueAt(i, 3).toString());
            cbbThuongHieu.setSelectedItem(tblChiTietSP.getValueAt(i, 4).toString());
            cbbNCC.setSelectedItem(tblChiTietSP.getValueAt(i, 5).toString());
            cbbDeGiay.setSelectedItem(tblChiTietSP.getValueAt(i, 6).toString());
            cbbSize.setSelectedItem(tblChiTietSP.getValueAt(i, 7).toString());
            txtGia.setText(tblChiTietSP.getValueAt(i, 8).toString());
            txtSoLuongTon.setText(tblChiTietSP.getValueAt(i, 9).toString());
            cbbTrangThai.setSelectedItem(tblChiTietSP.getValueAt(i, 10).toString());
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cbbThuongHieu, 0, 250, Short.MAX_VALUE)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cbbNCC, 0, 250, Short.MAX_VALUE)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cbbTrangThai, 0, 250, Short.MAX_VALUE)
                    .addComponent(txtGia)
        ...
        tblChiTietSP.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã SP", "Tên SP", "Tên Ảnh", "Màu Sắc", "Thương Hiệu", "Nhà Cung Cấp", "Đế Giày", "Size", "Giá", "Số Lượng", "Trạng Thái"
            }
        ));
        ...
        btnAdd1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Create.png"))); // NOI18N
        btnAdd1.setText("Mới");
